...
import static cn.BokerLite.gui.EV0.entity.DefaultPlayerSkin.TEXTURE_ALEX;
import static cn.BokerLite.gui.EV0.entity.DefaultPlayerSkin.TEXTURE_STEVE;
...
public final class FakeEntityPlayer extends EntityOtherPlayerMP {
    ...
    public FakeEntityPlayer(@NotNull GameProfile profile, @Nullable ResourceLocation locationSkin) {
        ...
        try {
            getGameProfile().getProperties().asMap().get("textures").stream().findFirst().map(property -> {
