...
public class colorSetting extends Downward<ColorValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        float x2 = pos.x + modulex + 27.5f + 127;
        float y2 = colory + moduley + 55 + 2;

        float width = 11;
        float height = 5;

        //Value名字
        FontLoaders.NL18.drawString(colorValue.getName(),pos.x + modulex + 27.5f,colory + moduley + 55, -1);
        //绘制调色板SKID
    ...
    public boolean isHovered(int mouseX, int mouseY) {
        return mouseX >=pos.x + modulex + 27.5f + 127 && mouseX <=pos.x + modulex + 27.5f + 127 + 13 && mouseY >= colory + moduley + 55 + 2 && mouseY <=(colory + moduley + 55 + 2 - 0.5 + 8);
    }
    ...
    public float getExpandedX() {
        return pos.x + modulex + 27.5f + 127 + 11 - 80.333336f;
    }

    public float getExpandedY() {
        return colory + moduley + 55 + 2 + 5;
    }
    public float getExpandedWidth() {
        float right = pos.x + modulex + 27.5f + 125 + 11;
