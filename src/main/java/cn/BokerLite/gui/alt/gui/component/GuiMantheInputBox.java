...
public class GuiMantheInputBox extends GuiTextField {
    ...
    public GuiMantheInputBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawBordered(this.xPosition, this.yPosition, this.width, this.height, isFocused ? 0.1 : 0, new Color(23, 23, 23).getRGB(), new Color(23, 168, 137).getRGB());
            }
            ...
            if (s.length() > 0) {
                ...
                FontRenderer.F16.drawString(s1, l, i1, i);
                j1 += FontRenderer.F16.getStringWidth(s1);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                FontRenderer.F16.drawString(s.substring(j), j1, i1, i);
            }

            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + FontRenderer.F16.getFontHeight(), -3092272);
                } else {
                    FontRenderer.F16.drawString("_", k1, i1, i);
                }
            }

            if (k != j) {
                int l1 = l + this.fontRendererInstance.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + FontRenderer.F16.getFontHeight());
            }
        }
    }
