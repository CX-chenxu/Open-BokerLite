...
public class PlayerUtils
{
    ...
    public static boolean isOnGround(final double height) {
        return !Helper.mc.theWorld.getCollidingBoundingBoxes(Helper.mc.thePlayer, Helper.mc.thePlayer.getEntityBoundingBox().offset(0.0, -height, 0.0)).isEmpty();
    }
    ...
    public static void tellPlayer(final String string) {
        if (string != null && PlayerUtils.mc.thePlayer != null) {
            PlayerUtils.mc.thePlayer.addChatMessage(new ChatComponentText("��c[DEBUG] ��r " + string));
        }
    }
