...
public class CombatUtil {
    ...
    public static float[] getRotationsnull(Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
            ...
            diffY = (entity.getEntityBoundingBox().minY + entity.getEntityBoundingBox().maxY)
                    / 2.0D
                    - (mc.thePlayer.posY + mc.thePlayer
                    .getEyeHeight());
...
//        final float[] maxRotations = getMaxRotations(box);
//        final float yaw = getRandomIntegerInRange(new Random(), (int) maxRotations[0], (int) maxRotations[1]);
//        final float pitch = getRandomIntegerInRange(new Random(), maxRotations[2], maxRotations[3]);
//        return new float[] { yaw, pitch };
//    }
